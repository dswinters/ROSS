...
Modify the main ~Config~ structure before any processing has been done. This can
be used to set up user-defined file and directory structures programatically for
