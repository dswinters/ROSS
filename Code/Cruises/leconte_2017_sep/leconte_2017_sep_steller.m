...
vessel.dirs.proc = [scishare 'data/processed/ADCP_steller/'];
vessel.dirs.figs = [scishare 'figures/ADCP_steller/'];

dep = 0;

defaults.proc.heading_offset = 40.86 - 8.5; % adcp mounting offset + hemisphere mounting offset
