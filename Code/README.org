...
| proc.adcp_load_args            | A cell array of additional arguments to be passed to adcp_load_func                         |
| proc.imu_load_args             | A cell array of additional arguments to be passed to read_imu.m                             |
...
| files.adcp                     | A glob pattern to find ADCP files within dirs.raw                                           |
| files.gps                      | A glob pattern to find GPS files within dirs.raw                                            |
| files.imu                      | A glob pattern to find IMU files within dirs.raw                                            |
